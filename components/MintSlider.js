...
function MintSlider(props) {
    ...
    const CONTRACT_ADDRESS = "0xe9eE9C90891f8885e8f5331b5F8Bd45004c96b82";
    ...
    async function mint(value, srcAddress, contractAddress){
        ...
        let contract = new w3.eth.Contract(CONTRACT_ABI, contractAddress);
        ...
        const gasEstimate = await _contractMethod.estimateGas(tx).catch((err) => alert(err));   // improved gas estimation as suggested by wetcircle
